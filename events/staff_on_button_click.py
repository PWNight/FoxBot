...
class StaffButtonClick(commands.Cog):
    ...
    async def on_button_click(self, inter):
        ...
        \n`4)` Отсутствие нарушений на проекте.
        \n`5)` Не менее 100 отыгранных часов. Допускается не более 10 часов из 100 в АФК.
        \n`6)` Необходимо быть участником Discord сервера не менее 3-х месяцев.''', color = 0x2f3136)
